...
define([
  ...
  Map, SceneView, ElevationLayer, SceneLayer, FeatureLayer, Query,
  ...
  return declare(null, {
    ...
    init: function(containers) {
      ...
      var infoPoints = new FeatureLayer({
        ...
        visible: false,
		definitionExpression: "HEIGHTROOF > 25 AND CNSTRCT_YR > " + settings.buildingOptions.minCnstrctYear + " AND CNSTRCT_YR <= " + settings.buildingOptions.maxCnstrctYear
      });
